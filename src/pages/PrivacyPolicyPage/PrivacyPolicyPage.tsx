...
export const PrivacyPolicyPage : FunctionComponent<{}> = () => {
  return (
    <>
      ...
      <li>
      <p><strong>Website</strong> refers to UALYRICS, accessible from <a href="https://ualyrics.com/" rel="external nofollow noopener" target="_blank">https://ualyrics.com/</a></p>
      </li>
      <li>
